...
DevelHome="/home/opensim/develop"
...
echo "==== check Database ageinst (latest) OSgrid AkiSim OpenSim.ini ========================"
perl checkDatabaseAgainstAkiOpenSimIni.pl "$DevelHome/akisim/doc/osgrid/ini/OpenSim.ini" OSgrid
