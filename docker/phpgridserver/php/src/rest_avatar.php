...
{
	trigger_error("/avatar Method=".$_RPC_REQUEST->Method);
}
...
else if(!file_exists("avatar/rpc_".$_RPC_REQUEST->Method.".php"))
{
	http_response_code("400");
	exit;
}
...
{
	require_once("avatar/rpc_".$_RPC_REQUEST->Method.".php");
}
